module.exports = function(app) {
  ...
  entryListsRouter.get('/', function(req, res) {
    res.send({
      ...
      'entry': [
        { id: 4, title: 'International Shipping: Staging deploy' },
        { id: 3, title: 'International Shipping: Optional zip code' },
        { id: 2 , title: 'International Shipping: Optional state' },
        { id: 1 , title: 'Generic import' }
      ]
    });
  });
